  ...
  return (
    <>
      ...
      <div className="about_container">
        ...
        >
          <p>
            Founded on the belief that innovation should simplify, not
            complicate, our mission at Quantum Leap Innovations is to bring
            next-generation solutions to the logistics industry. Our product is
            built from the ground up to bridge the gap between technology and
            operational efficiency—ensuring that businesses can move forward
            without being held back by outdated systems.
          </p>
        </motion.div>
      </div>
    </>
