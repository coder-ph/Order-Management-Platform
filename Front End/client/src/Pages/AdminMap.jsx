...
const mockVehicles = [
  {
    ...
    driver: { name: "John Doe", phone: "+254712345678" },
  }, 
  {
    id: 2,
    position: [-1.2864, 36.8172],
    driver: { name: "Jane Smith", phone: "+254798765432" },
  }, 
  {
    id: 3,
    position: [0.5143, 35.2698],
    driver: { name: "Peter Mwangi", phone: "+254723456789" },
  }, 
  {
    id: 4,
    position: [0.0236, 37.9062],
    driver: { name: "Alice Wanjiru", phone: "+254701234567" },
  }, 
];
